...
export default function Sidebar() {
  ...
  return (
    <>
      <div className="md:hidden flex items-center justify-between bg-wine text-ivory px-4 py-3 sticky top-0 z-30">
        <Logo size="sm" className="text-ivory" />
      ...
      <aside className="hidden md:flex md:flex-col w-64 shrink-0 bg-wine min-h-screen sticky top-0">
        <SidebarContent />
      </aside>
