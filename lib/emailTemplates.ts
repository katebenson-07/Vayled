...
export const DEFAULT_TEMPLATES: Omit<EmailTemplate, "id" | "studio_id" | "created_at">[] = [
  ...
  },
  {
    ...
    subject: "Your preview session is coming up",
    body: "Hi {{bride_name}},\n\nJust a reminder about your upcoming preview session — can't wait to see you!",
  },
  {
    name: "Preview time options",
    subject: "Pick your preview time",
    body:
      "Hi {{bride_name}},\n\nI have a few openings for your bridal preview — pick whichever works best for you here:\n\n{{trial_pick_link}}\n\nCan't wait to see you!",
  },
  {
    name: "Preview prep questionnaire",
    subject: "A few quick questions before your preview",
    body:
      "Hi {{bride_name}},\n\nSo excited for your preview! To help me prep, could you answer a few quick questions beforehand?\n\n1. What's your hair type/texture (fine, thick, curly, color-treated)?\n2. Any skin sensitivities, allergies, or products to avoid?\n3. Do you have inspo photos for hair and/or makeup you'd like to send over?\n4. What's the overall vibe you're going for (natural, glam, romantic, editorial)?\n5. Will anyone be joining you at the preview?\n\nSee you soon!",
  },
  {
